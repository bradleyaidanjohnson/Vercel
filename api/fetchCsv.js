...
module.exports = async function handler(req, res) {
  const CSV_URL = 'https://jemstonerecruitment-my.sharepoint.com/:x:/p/jemma/ESF_iG50PUhGvwJsrGZIF4cBHY4cZj1WZ1ieHEYRDsMxEg?e=jI4vJr&download=1'; // replace with your actual URL
